...
#define MUX_PB_BUG() \
 ...
 /*GPMC*/\
	...
	MUX_VAL(CP(GPMC_NCS2),	(IDIS | PTD | DIS  | M4)) /*LCLK_1V8*/\
	MUX_VAL(CP(GPMC_NCS3),	(IEN  | PTU | EN   | M4)) /*LFRAME_1V8*/\
	MUX_VAL(CP(GPMC_NCS4),	(IEN  | PTU | EN   | M4)) /*LAD_OMAP0*/\
 ...
 /*Serial Interface*/\
	...
	MUX_VAL(CP(HDQ_SIO),	(IDIS | PTD | DIS | M4)) /*ASIC_RESET#*/\
