...
#define MUX_PB_BUG() \
 ...
 /*GPMC*/\
	...
	MUX_VAL(CP(GPMC_A4),	(IDIS | PTD | EN  | M4)) /*O_CAM_PWRDN#	  */\
	MUX_VAL(CP(GPMC_A5),	(IDIS | PTD | EN  | M4)) /*O_CAM_RCLK_R/F#*/\
	MUX_VAL(CP(GPMC_A6),	(IDIS | PTD | EN  | M4)) /*WIFI_RED	  */\
	MUX_VAL(CP(GPMC_A7),	(IDIS | PTD | EN  | M4)) /*WIFI_GREEN	  */\
	MUX_VAL(CP(GPMC_A8),	(IDIS | PTD | EN  | M4)) /*WIFI_BLUE	  */\
 ...
 /*CAMERA*/\
	...
	MUX_VAL(CP(CAM_XCLKA),	(IDIS | PTD | DIS | M4)) /*USB_SUSP*/\
	MUX_VAL(CP(CAM_PCLK),	(IEN  | PTU | EN  | M0)) /*CAM_PCLK*/\
	MUX_VAL(CP(CAM_FLD),	(IDIS | PTD | DIS | M4)) /*CAM_BUF_OE*/\
							 /* - CAM_RESET*/\
	...
	MUX_VAL(CP(CAM_D8),	(IDIS  | PTD | DIS | M4)) /*DOCK_RESET	*/\
	MUX_VAL(CP(CAM_D9),	(IDIS  | PTD | DIS | M4)) /*MUTE	*/\
	MUX_VAL(CP(CAM_D10),	(IDIS  | PTD | DIS | M4)) /*DR_MSECURE	*/\
	MUX_VAL(CP(CAM_D11),	(IEN  | PTU | EN | M4))   /*SW_STATUS	*/\
 ...
 /*Wireless LAN */\
	...
	MUX_VAL(CP(MMC2_DAT7),	(IEN  | PTU | EN  | M4)) /*DDR_TEMP_SENSE*/\
 /*Bluetooth*/\
 ...
 /*Modem Interface */\
	...
	MUX_VAL(CP(MCBSP4_FSX),	(IDIS | PTD | DIS | M4)) /*GPIO_155*/\
							 /* - LCD_RESB */\
	MUX_VAL(CP(MCBSP1_CLKR),(IDIS | PTD | DIS | M4)) /*BT_RESET */\
	MUX_VAL(CP(MCBSP1_FSR),	(IDIS | PTD | DIS | M4)) /*WIFI_RESET*/\
 ...
 /*Serial Interface*/\
	...
	MUX_VAL(CP(HDQ_SIO),	(IEN  | PTU | EN  | M4)) /*SD2_CD*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(ETK_CLK_ES2),(IEN | PTU | EN | M4)) /*M4_PRESENT*/\
	MUX_VAL(CP(ETK_CTL_ES2),(IEN | PTU | EN | M4)) /*PIM4_INT*/\
	MUX_VAL(CP(ETK_D0_ES2 ),(IEN | PTU | EN | M4)) /*M2_PRESENT*/\
	MUX_VAL(CP(ETK_D1_ES2 ),(IEN | PTU | EN | M4)) /*PIM2_INT*/\
	MUX_VAL(CP(ETK_D2_ES2 ),(IEN | PTU | EN | M4)) /*M1_PRESENT*/\
	MUX_VAL(CP(ETK_D3_ES2 ),(IEN  | PTU | EN | M2)) /*SD3_DAT3*/\
	MUX_VAL(CP(ETK_D4_ES2 ),(IEN  | PTU | EN | M2)) /*SD3_DAT0*/\
	MUX_VAL(CP(ETK_D5_ES2 ),(IEN  | PTU | EN | M2)) /*SD3_DAT1*/\
	MUX_VAL(CP(ETK_D6_ES2 ),(IEN  | PTU | EN | M2)) /*SD3_DAT2*/\
	MUX_VAL(CP(ETK_D7_ES2 ),(IEN  | PTU | EN | M4)) /*PIM1-INT*/\
	MUX_VAL(CP(ETK_D8_ES2 ),(IEN  | PTU | EN | M4)) /*M3_PRESENT*/\
	MUX_VAL(CP(ETK_D9_ES2 ),(IEN  | PTU | EN | M4)) /*PIM3_INT*/\
